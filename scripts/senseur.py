...
def evaluate_model(model_name, history):
    ...
    results_file_name = f"../results/SensEUR-results.csv"
...
def main(dataframe, train_task_name):
    ...
    metrics = ["accuracy", f1_score_macro, f1_score_avg]
...
if __name__ == "__main__":
    for _ in range(1):
        with device("/GPU:0"):
            dataframe = pd.read_excel("datasets/SensEUR.xlsx")
            label_dict = {
            ...
            main(dataframe, "DeepMetaIoT SensEUR")
